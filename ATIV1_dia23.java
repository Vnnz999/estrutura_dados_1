...
public class ATIV1_dia23 {
    public static void main(String[] args) {
        ...
        try {
            ...
            switch (dia) {
                case SEGUNDA:
                    System.out.println("Prova de banco de dados");
                    break;
                case TERCA:
                    System.out.println("Prova de algoritimos");
                    break;
                case QUARTA:
                    System.out.println("Prova de 2 materias enjoadas");
                    break;
                case QUINTA:
                    System.out.println("Prova de nao sei");
                    break;
                case SEXTA:
                    System.out.println("Prova do heberson");
                    break;
                case SABADO:
                case DOMINGO:
                    System.out.println("Final de semana, sem provas!");
                    break;
                default:
